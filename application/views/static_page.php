    ...
    <tr class="mainPart">
        ...
        <td id="cadrePrincipal" colspan="5">
            ...
            if(isset($SQLResult)){
                ...
                echo "<tr><td><b>course name: </b>" . $book->coursecode . "</td><td><h4>€" . $book->price . "</h4></td></tr>";
                echo"<tr><td ><a type=\"button\" value=\"".$book->id."\" href=\"" . $siteurl . "/mainpage/addCart/" . $book->id . "\" class=\"btn btn-success\">Buy it !</a><td><a  class=\"btn btn-link\" role=\"button\" value=\"".$book->id."\" href=\"".$siteurl."/mainpage/book/".$book->id."\" >More Details</a></td></td></tr>";
                }
